...
<?php
	if(get_request_method()=="POST"){
		$url = $_POST['url'];
		$method = $_POST['method'];
		$dic_headers = json_decode(base64_decode($_POST['headers']),true);
	...
	echo '<h1>Simple Proxy</h1><blockquote><p>Developed by <a href="https://www.boxpaper.club/" target=_blank"">Boxpaper</a></p></blockquote>';
	 } ?>